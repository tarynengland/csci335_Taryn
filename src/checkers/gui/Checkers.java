...
public class Checkers extends JFrame {
    ...
    private EvalFunc evaluation;
    private Searcher searchAlg;
    private JTextField depthField, nodeField, timeField;
    private AIReflector<EvalFunc> evalFuncClasses;
    private AIReflector<Searcher> searcherClasses;
    ...
    public Checkers() {
    	...
    	evalFuncClasses = new AIReflector<>(EvalFunc.class, "checkers.evaluators");
    	...
    	searcherClasses = new AIReflector<>(Searcher.class, "checkers.searchers", EvalFunc.class);
    ...
    private void loadAlgorithms() {
        searchAlg = Searcher.makeSearcher((String)searchers.getSelectedItem(), (String)evalFuncs.getSelectedItem(), evalFuncClasses, searcherClasses);
        if (searchAlg == null) {
    ...
    private class Evaluator implements ActionListener {
        public void actionPerformed(ActionEvent e) {
            ...
            if (e.getSource() == evaluate) {
                v = evaluation.evaluate(board.getBoard());
            } else if (e.getSource() == evalSearch) {
                v = searchAlg.selectMove(board.getBoard()).getScore();
            }
    ...
    private class ComputerMover implements ActionListener {
        public void actionPerformed(ActionEvent e) {
            if (!board.getBoard().gameOver()) {
            	...
            	Move choice = searchAlg.selectMove(board.getBoard()).getMove();
